...
public class FilesRVAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public interface filesRVItemClickedListener {
        void onItemClicked(int position, float[] coordinates); // RV Item Clicked
    ...
    public class FilesRVGridItemVH extends RecyclerView.ViewHolder {
        ...
        private ImageView icon, centerOfIcon;
        ...
        public FilesRVGridItemVH(@NonNull View itemView) {
            ...
            rvItemContainer.setOnTouchListener(new View.OnTouchListener() {
                @Override
                public boolean onTouch(View v, MotionEvent event) {
                    ...
                    if (event.getActionMasked() == MotionEvent.ACTION_DOWN) {
                        ...
                        lastTouchDownXY[0] = rvItemContainer.getX() + rvItemContainer.getWidth()/2;
                        lastTouchDownXY[1] = rvItemContainer.getY() + rvItemContainer.getHeight()/2;
                    }
                    return false;
                }
            });
            ...
            rvItemContainer.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    listener.onItemClicked(getAdapterPosition(), lastTouchDownXY);
                }
            });
        ...
        public FilesRVLinearItemVH(@NonNull View itemView) {
            ...
            rvItemContainer.setOnTouchListener(new View.OnTouchListener() {
                ...
                public boolean onTouch(View v, MotionEvent event) {
                    // save the X,Y coordinates
                    if (event.getActionMasked() == MotionEvent.ACTION_DOWN) {
                        lastTouchDownXY[0] = event.getRawX();
                        lastTouchDownXY[1] = event.getRawY();
                    }
                    return false;
                }
            });
